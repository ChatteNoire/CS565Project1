...
def client():
    ...
    # restricted range due to processing time (between 2 and 2000)
    while p1 == p:   # p1 != p
        p1 = sympy.randprime(2,2000) # random 'p1' prime (secret)
    ...
    with open('received_file.txt', 'wb') as f: # write as byte
        ...
        # get DataSize from server so print properly
        s.send(b'MD5 hash processing done...\n') # acknowledge MD5 processing done
