...
def serve():
    ...
    while True:
        ...
        # file to transfer
        filename='sample.txt'
        f = open(filename,'rb') #formerly rb from template (read all at once)
...
#LV            
        print('file=>',l,'len=>',len(l))
        #l = l.rjust(16) # right justified, width of string
        #l = encode("utf-8")   # l as a string to bytes
        print('read: ',l)
